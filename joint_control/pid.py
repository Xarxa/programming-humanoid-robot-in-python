...
class PIDController(object):
    ...
    def control(self, target, sensor):
        ...
        error_current = target - sensor

        #P = self.Kp + self.Ki + (self.Kp / self.dt) * error_current
        P = self.Kp + self.Ki * self.dt + (self.Kd / self.dt) * error_current
